import {
  ...
  ɵzoneWrap
} from "./chunk-AWWQZFI4.js";
import "./chunk-CWLCFDWI.js";
import {
  InjectionToken,
  Injector,
  NgModule,
...
function _openDatabase() {
  ...
  return new Promise((resolve, reject) => {
    ...
    request.addEventListener("upgradeneeded", () => {
      ...
      try {
        db2.createObjectStore(DB_OBJECTSTORE_NAME, {
...
function _open(auth, url, name3, width = DEFAULT_WIDTH, height = DEFAULT_HEIGHT) {
  ...
  if (name3) {
    target = _isChromeIOS(ua3) ? TARGET_BLANK : name3;
  }
  if (_isFirefox(ua3)) {
...
function cf(t, e) {
  return t instanceof sf && e instanceof sf ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof of2 && e instanceof of2 && t._firestore === e._firestore && ph(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
function af(t) {
  t = uh(t, fh);
...
function df(t) {
  t = uh(t, dh);
  const e = uh(t.firestore, vh), n = bh(e), s = new hf(e);
  return El(t._query), Ha2(n, t._query).then((n2) => new of2(e, s, t, n2));
}
function wf(t) {
  t = uh(t, dh);
  const e = uh(t.firestore, vh), n = bh(e), s = new hf(e);
  return Wa2(n, t._query).then((n2) => new of2(e, s, t, n2));
}
function _f(t) {
  t = uh(t, dh);
  const e = uh(t.firestore, vh), n = bh(e), s = new hf(e);
