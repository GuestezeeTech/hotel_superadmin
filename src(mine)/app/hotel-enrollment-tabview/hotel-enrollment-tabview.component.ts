...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, MenuBarComponent, OfficeDetailsComponent, PropertyDetailsComponent, ServiceTabListComponent, PaymentSubscriptionManagementCustomerComponent, HierarchyDetailsComponent, TechnicalInfoComponent, CommonModule],
