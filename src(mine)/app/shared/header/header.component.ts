...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.notificationService.notifications$.subscribe(list => this.notifications = this.groupNotificationsByDay(list));
  ...
  get activeMenu(): string {
    ...
    else if (currentRoute.includes('hotel-reviews')) {
      return (this.selectedMenu = "Hotel Reviews");
    }
    else if (currentRoute.includes('hotel-details')) {
      return (this.selectedMenu = "Hotel Details");
    }
