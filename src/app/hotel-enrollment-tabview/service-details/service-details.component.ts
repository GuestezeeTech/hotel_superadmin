    ...
    let requestBody = {
      ...
      extras: {
        find: {
          ...
          customer_member_id: this.hotelId //newly changed from customer_id to customer_member_id
        }
      }
    }
    //console.log("123")
      ...
      resp => {
        ...
        if (resp) {
          if (resp.success === 1 && resp.status_code === 200) {
            ...
            this.services = resp.result.data.filter((service: any) => service.customer_member_id === undefined); //newly changed from customer_id to customer_member_id
            //console.log(this.services,"this.services")
